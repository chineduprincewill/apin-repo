...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await signup(fullname, email, password, confirm_password);
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background">
            <div className="w-full z-30 grid grid-cols-1 lg:grid-cols-2 min-h-screen">
                ...
                {/* Right Form */}
                <div className="bg-gray-100 dark:bg-blue-950 flex flex-col items-center justify-center p-3 sm:p-4 lg:p-6">
                    <div className="w-full max-w-lg">
                        <div className="mb-8">
                        <h1 className="text-3xl font-boldmb-2">Sign Up</h1>
                        <p className="text-muted-foreground">Enter your credentials to create your account</p>
                        </div>
                        {/* Error Message */}
                        {error && (
                            <div className="mb-6 p-3 bg-destructive/10 border border-destructive/20 rounded-none">
                            ...
                            <div className="w-full space-y-2">
                                ...
                                <div className='w-full flex items-center gap-0'>
                                    <Input
                                        ...
                                        required
                                    />
                                    <div className='flex items-center bg-input h-14 pr-2'>
                                    {
                                        eyeopen ? 
                                            <Eye 
                        ...
                        <Button
                            variant="outline"
                            className="h-10 border-border rounded-none hover:bg-muted transition"
                        >
